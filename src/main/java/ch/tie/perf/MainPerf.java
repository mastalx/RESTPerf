...
public class MainPerf {
  ...
  public static Option HELP_OPT = new Option("help", "print this message");

  public static Option THREADS_OPT = Option.builder("t")
      .longOpt("threads")
      .hasArg()
      .type(Integer.class)
  ...
  public static Option ENDPOINT_OPT = Option.builder("u")
      .longOpt("url")
      .hasArg()
      .required()
  ...
  public static Option SAVE_FILE_OPT = Option.builder("s")
      .longOpt("savefile")
      .hasArg()
      .type(Boolean.class)
  ...
  public static Option EXPERIMENT_NAME_OPT = Option.builder("e")
      .longOpt("experiment")
      .hasArg()
      .type(Boolean.class)
